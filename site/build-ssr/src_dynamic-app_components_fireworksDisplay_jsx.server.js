"use strict";
exports.id = "src_dynamic-app_components_fireworksDisplay_jsx";
exports.ids = ["src_dynamic-app_components_fireworksDisplay_jsx"];
exports.modules = {
    ...
    const sketch = p => {
      ...
      class Firework {
        constructor(x, y, targetX, targetY, col, type) {
          ...
          let baseCount;
          if (p.windowWidth < 768) {
            baseCount = type === 'BLINKING' ? p.random(150, 275) : p.random(125, 225);
          } else if (p.windowWidth <= 1024) {
            baseCount = type === 'BLINKING' ? p.random(275, 325) : p.random(200, 250); // Fewer PROJECTILE particles on medium screens
          } else {
            baseCount = type === 'BLINKING' ? p.random(250, 300) : p.random(300, 350);
          }
...
;
//# sourceMappingURL=src_dynamic-app_components_fireworksDisplay_jsx.server.js.map